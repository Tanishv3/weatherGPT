...
async def ws_chat(websocket: WebSocket):
    ...
    # weather replies.
    ai_enabled = settings.llm_provider == "openai" and bool(settings.openai_api_key)
...
async def _handle_message(websocket: WebSocket, session: Session, payload: dict) -> None:
    ...
    await manager.send(websocket, {
        ...
        "mode": "ai" if settings.llm_provider == "openai" and settings.openai_api_key else "local",
    })
